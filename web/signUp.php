                            ...
                            <div class="panel-heading">
                                ...
                                <hr>
                                    ...
                                    <form action="createAccount.php" method="POST" id="register-form" class="registerForm" style="display: none;">
                                        <div class="input-group">
                                            <input type="text" id="rname" name="rname" class="form-control" placeholder="User Name">
                                            <input type="password" id="rpaw" name="rpaw" class="form-control" placeholder="Password">
